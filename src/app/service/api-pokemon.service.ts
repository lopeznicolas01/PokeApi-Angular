...
export class ApiPokemonService {
  ...
  private urlApi = "https://pokeapi.co/api/v2/pokemon?limit=5&offset=0";
  ...
  public getLocalDataDetail(name): Observable<any>{  
    let finalUri=this.urlApiLocal+"traerPokemon"
    let body= {
      "name": name
    }
